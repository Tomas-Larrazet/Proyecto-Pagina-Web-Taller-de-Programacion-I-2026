                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="stock_minimo" class="form-label">Alerta de Stock Bajo (Mínimo)</label>
                                <input type="number" class="form-control" id="stock_minimo" name="stock_minimo" value="{{ old('stock_minimo', $producto->stock_minimo) }}" required min="0">
                            </div>
                        </div>
